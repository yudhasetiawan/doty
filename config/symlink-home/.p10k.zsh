# Generated by Powerlevel10k configuration wizard on 2024-02-27 at 17:45 WIB.
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_BACKGROUND=62
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_CLASSES=(
      ...
      '*'          DEFAULT)
  typeset -g POWERLEVEL9K_KUBECONTEXT_DEFAULT_FOREGROUND=83
  typeset -g POWERLEVEL9K_KUBECONTEXT_DEFAULT_BACKGROUND=54
  typeset -g POWERLEVEL9K_KUBECONTEXT_STAGING_FOREGROUND=14
  typeset -g POWERLEVEL9K_KUBECONTEXT_STAGING_BACKGROUND=18
  typeset -g POWERLEVEL9K_KUBECONTEXT_PROD_FOREGROUND=155
  ...
  function prompt_doty_watson() {
    p10k segment -b ${(g::)POWERLEVEL9K_DOTY_WATSON_BACKGROUND} -f ${(g::)POWERLEVEL9K_DOTY_WATSON_FOREGROUND} -t "$(watson status)" -i "${(g::)POWERLEVEL9K_DOTY_WATSON_ICON}"
  }
  ...
  function instant_prompt_doty_watson() {
  ...
  typeset -g POWERLEVEL9K_DOTY_WATSON_BACKGROUND=197
  typeset -g POWERLEVEL9K_DOTY_WATSON_FOREGROUND=226
  typeset -g POWERLEVEL9K_DOTY_WATSON_ICON='👻 '
